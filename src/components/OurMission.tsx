...
export const OurMission = () => {
    return (
        <>
            <h1 className="text-primary text-3xl"> Our Mission </h1>
            <div>
            ...
            <div className="flex flex-col md:flex-row gap-3">
                <div className="text-center border-2 border-primary bg-background-200 text-text p-3">
                    <CiHeart className="mx-auto text-7xl mb-6 text-primary" />
                ...
                <div className="text-center border-2 border-primary bg-background-200 text-text p-3">
                    <PiPottedPlantThin className="mx-auto text-7xl mb-6 text-primary" />
                    <h3 className="text-xl">Donate</h3>
                    <p>Your generous donation helps our nonprofit support the local community gardens and gardeners!</p>
                </div>
                <div className="text-center border-2 border-primary bg-background-200 text-text p-3">
                    <TbShovel className="mx-auto text-7xl mb-6 text-primary stroke-[.8px]" />
                    <h3 className="text-xl">Donate</h3>
                    <p>Your generous donation helps our nonprofit support the local community gardens and gardeners!</p>
                </div>
            </div>
